...
function isItemActive(pathname: string, href: string) {
  ...
  if (href === "/admin/super/site") return pathname === href;
  ...
  return (
    <Link
      ...
      className={[
        ...
        subItem
          ? "ml-5 border-l border-cyan-400/20 rounded-l-none px-4 text-xs"
          : "px-4",
        active
    ...
    >
      {subItem ? (
        <span className="mr-2 text-cyan-400/70">└</span>
      ) : null}
...
export default function SuperAdminShell({
  ...
  const navItems: SuperNavItem[] = [
    ...
    {
      href: "/admin/super/site/funcionalidades",
      label: "Funcionalidades",
      subItem: true,
    },
    {
      href: "/admin/super/site/midias",
      label: "Mídias públicas",
      subItem: true,
    },
    {
      href: "/admin/super/site/planos",
    ...
    {
      href: "/admin/super/site/atualizacoes",
      label: "Atualizações",
      subItem: true,
    },
  ];
          ...
          <div className="flex h-full flex-col">
            ...
            <div className="border-t border-cyan-400/10 p-4">
              <div className="mb-3 rounded-2xl border border-cyan-400/10 bg-cyan-400/[0.04] px-4 py-3">
                ...
                <div className="mt-1 text-xs text-zinc-400">Super Admin</div>
